...
export default function Suggestions() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            let viewedIds = [];
            let likedIds = [];
            try { searchHistory = JSON.parse(getCookie('searchHistory')) || []; } catch { }
            try { viewedIds = JSON.parse(getCookie('viewedProducts')) || []; } catch { }
            try { likedIds = JSON.parse(getCookie('likedProducts')) || []; } catch { }
